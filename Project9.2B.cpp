...
void Create(Student* p, const int N)
{
    ...
    for (int i = 0; i < N; i++)
    {
        ...
        else if (p[i].specilty == INFORMTECH) {
            cout << " Чисельні методи: "; cin >> p[i].varmetod;
        }
        else {
...
void Print(Student* p, const int N)
{
    ...
    for (int i = 0; i < N; i++)
    {
        ...
        if (p[i].specilty == KOMPSCINCE)
            cout << setw(13) << right << p[i].program << " | " << setw(15) << "-" << " | " << setw(10) << "-";
        else if (p[i].specilty == INFORMTECH)
            cout << setw(13) << "-" << " | " << setw(15) << right << p[i].varmetod << " | " << setw(10) << "-";
        else
            cout << setw(13) << "-" << " | " << setw(15) << "-" << " | " << setw(10) << right << p[i].pedagogic;
...
void PrintIndexSorted(Student* p, int* I, const int N)
{
    ...
    for (int i = 0; i < N; i++)
    {
        ...
        if (p[I[i]].specilty == KOMPSCINCE)
            cout << setw(13) << right << p[I[i]].program << " | " << setw(15) << "-" << " | " << setw(10) << "-";
        else if (p[I[i]].specilty == INFORMTECH)
            cout << setw(13) << "-" << " | " << setw(15) << right << p[I[i]].varmetod << " | " << setw(10) << "-";
        else
            cout << setw(13) << "-" << " | " << setw(15) << "-" << " | " << setw(10) << right << p[I[i]].pedagogic;
